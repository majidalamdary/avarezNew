...
public class item_detail_parvandeh_adapter extends RecyclerView.Adapter<item_detail_parvandeh_adapter.my_view_holder> {
    ...
    String
            font_name = "";
    Typeface tf;
    public item_detail_parvandeh_adapter(Context context, List<items> item) {
    ...
    public my_view_holder onCreateViewHolder(ViewGroup parent, int viewType) {
       View view= LayoutInflater.from(context).inflate(R.layout.list_parvandeh_item,parent,false);
